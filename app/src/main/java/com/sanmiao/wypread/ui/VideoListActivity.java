...
import com.sanmiao.wypread.adapter.VideoListAdapter;
...
public class VideoListActivity extends BaseActivity {
    ...
    @InjectView(R.id.list_downlv)
    LinearLayout listDownlv;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listDownlv.setVisibility(View.GONE);
    ...
    private void initView() {
        ...
        adapter.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                startActivity(new Intent(VideoListActivity.this, VideoDetailsActivity.class).putExtra("videoID", list.get(i).getBookID()));
            }
        });
    ...
    private void initData(String sorttype, String order) {
        ...
        OkHttpUtils.post().url(MyUrl.classifyItem).params(map).tag(this).build().execute(new StringCallback() {
            ...
            public void onError(Request request, Exception e) {
                ...
                Toast.makeText(VideoListActivity.this, "网络连接失败", Toast.LENGTH_SHORT).show();
                if (list.size() > 0) {
            ...
            public void onResponse(String response) {
                ...
                if (bean.getResultCode() == 0) {
                    ...
                    Toast.makeText(VideoListActivity.this, bean.getMsg(), Toast.LENGTH_SHORT).show();
            }
        });
    }

    @OnClick({R.id.list_defout, R.id.list_click, R.id.list_bestNew})
