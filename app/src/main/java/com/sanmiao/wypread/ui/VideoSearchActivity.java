...
import com.sanmiao.wypread.adapter.VideoSearchAdapter;
...
public class VideoSearchActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        initImg();
        downLv.setVisibility(View.GONE);
        setDefoult();
    ...
    private void initData() {
        ...
        OkHttpUtils.post().url(MyUrl.search).params(map).tag(this).build().execute(new StringCallback() {
            ...
            public void onError(Request request, Exception e) {
                ...
                Toast.makeText(VideoSearchActivity.this, "网络连接失败", Toast.LENGTH_SHORT).show();
    ...
    private void initView() {
        ...
        adapter = new VideoSearchAdapter(this, list, false);
        ...
        adapter.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                startActivity(new Intent(VideoSearchActivity.this, VideoDetailsActivity.class).putExtra("videoID", list.get(i).getBookID()));
            }
        });
    }
