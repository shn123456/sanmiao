...
public class VideoAdapter extends SunStartBaseAdapter {
    public VideoAdapter(Context context, List<?> list, boolean Load) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        ImageView bottom1 =holder.getImageView(R.id.read_bottomVideo1);
        ImageView bottom2 =holder.getImageView(R.id.read_bottomVideo2);
        ImageView bottom3 =holder.getImageView(R.id.read_bottomVideo3);
        LinearLayout lv = holder.get(R.id.book_lv);
        ...
        if(i==1){
            bottom1.setImageResource(R.mipmap.icon_play_difen);
            bottom2.setImageResource(R.mipmap.icon_play_difen);
            bottom3.setImageResource(R.mipmap.icon_play_difen);
        }else if(i==2){
            bottom1.setImageResource(R.mipmap.icon_play_bohong);
            bottom2.setImageResource(R.mipmap.icon_play_bohong);
            bottom3.setImageResource(R.mipmap.icon_play_bohong);
        }else if(i==3){
            bottom1.setImageResource(R.mipmap.icon_play_lan);
            bottom2.setImageResource(R.mipmap.icon_play_lan);
            bottom3.setImageResource(R.mipmap.icon_play_lan);
        }else if(i==4){
            bottom1.setImageResource(R.mipmap.icon_play_caolv);
            bottom2.setImageResource(R.mipmap.icon_play_caolv);
            bottom3.setImageResource(R.mipmap.icon_play_caolv);
        }else if(i==5){
            bottom1.setImageResource(R.mipmap.icon_play_yanzhi);
            bottom2.setImageResource(R.mipmap.icon_play_yanzhi);
            bottom3.setImageResource(R.mipmap.icon_play_yanzhi);
        }else{
            bottom1.setImageResource(R.mipmap.icon_play);
            bottom2.setImageResource(R.mipmap.icon_play);
            bottom3.setImageResource(R.mipmap.icon_play);
        }
        ...
        more.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                context.startActivity(new Intent(context, VideoListActivity.class).putExtra("className",bean.getName()).putExtra("classID",bean.getClassifyID()));
            }
        });
        ...
        if(bean.getItems().size()==1){
            ...
            img1.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {context.startActivity(new Intent(context, VideoDetailsActivity.class).putExtra("videoID",bean.getItems().get(0).getBookID()));}
            });
            ...
            img2.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    context.startActivity(new Intent(context, VideoDetailsActivity.class).putExtra("videoID",bean.getItems().get(1).getBookID()));
                }
            });
            ...
            img3.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    context.startActivity(new Intent(context, VideoDetailsActivity.class).putExtra("videoID",bean.getItems().get(2).getBookID()));
                }
            });
            bottom1.setVisibility(View.VISIBLE);
            bottom2.setVisibility(View.VISIBLE);
